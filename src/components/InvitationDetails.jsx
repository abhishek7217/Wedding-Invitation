  ...
  const events = [
    {
      ...
      description:
        "A traditional ritual to purify and bless the couple before the wedding festivities",
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-block text-center px-10 md:px-16 py-4 md:py-5 bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] text-[#2a0a0a] rounded-full text-lg md:text-xl font-semibold tracking-wider uppercase shadow-lg hover:shadow-xl hover:shadow-[#D4AF37]/20 transition-all duration-300 w-full"
            >
              Confirm Your Attendence 💬
            </motion.a>
