  ...
  const events = [
    {
      ...
      description:
        "A traditional ritual to purify and bless the couple before the wedding festivities begin 🌿",
    ...
    },
    {
      ...
      icon: <Users className="w-6 h-6" />,
      description:
        "An evening of music, dance, and celebration with family and friends 🎉",
      color: "from-[#D4AF37]/10 to-[#034127]/10",
    },
    {
      ...
      description:
        "The sacred union ceremony with traditional rituals and blessings 🥳🌺",
    ...
    <div className="relative z-20 min-h-screen bg-gradient-to-b from-[#2a0a0a] to-[#1a0505] py-12 md:py-24 px-4 md:px-8 text-center">
      ...
      <div className="w-full flex justify-center mb-8 md:mb-12 opacity-40">
        <svg
          ...
          viewBox="0 0 80 20"
          fill="none"
          className="md:w-24 md:h-28"
        >
          <path
            d="M0 20C0 20 15 0 40 0C65 0 80 20 80 20"
            stroke="#D4AF37"
            strokeWidth="1"
          />
        </svg>
      ...
      >
        With immense joy and gratitude, we invite you to witness and bless our
        sacred union. Your presence will make our special day complete.
      </motion.p>
            ...
            >
              ...
              <div className="pt-4">
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center mt-6 md:mt-8 px-6 md:px-8 py-3 bg-gradient-to-r from-[#D4AF37]/10 to-transparent border border-[#D4AF37]/30 text-[#D4AF37] rounded-full text-sm md:text-base hover:bg-gradient-to-r hover:from-[#D4AF37] hover:to-[#aa8c2c] hover:text-[#2a0a0a] transition-all duration-300 w-full"
                >
                  Get Directions
                </motion.a>
              </div>
      ...
      >
        ...
        <p className="text-[#D4AF37] text-lg mb-2">Traditional Indian Attire</p>
        <p className="text-gray-300 text-base">
          We request you to dress in traditional Indian wear to complement the
          occasion.
          <br />
          <span className="text-sm text-gray-400">
            Sarees, Lehengas, Sherwanis, or Kurta Pyjamas (Come with a lower and
            T-shirts if you don't have traditional attires 😉 But Please come!!)
          </span>
        </p>
      </motion.div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-[#D4AF37]/60 text-sm md:text-base">
              Please confirm your attendance by March 1st, 2026
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center justify-center px-10 md:px-16 py-4 md:py-5 bg-gradient-to-r from-[#D4AF37] to-[#aa8c2c] text-[#2a0a0a] rounded-full text-lg md:text-xl font-semibold tracking-wider uppercase shadow-lg hover:shadow-xl hover:shadow-[#D4AF37]/20 transition-all duration-300 w-full"
            >
